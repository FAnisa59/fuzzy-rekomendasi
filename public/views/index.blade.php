...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="{{ asset('css/normalize.css') }}?id=222">
  <link rel="stylesheet" type="text/css" href="{{ asset('fonts/icomoon.css') }}?id=222">
  <link rel="stylesheet" type="text/css" href="{{ asset('css/vendor.css') }}?id=222">
  <!--Bootstrap ================================================== -->
      ...
      <div class="row align-items-center">
        ...
        <div class="col-md-2 col-sm-4 brand-block ">
          <div class="main-logo text-lg-center">
            <a href="index.html">
              <img src="images/main-logo.png" alt="logo" class="brand-image">
            </a>
          </div>
        </div>
            ...
            <div class="user-items">
              <ul class="list-unstyled content-light d-flex align-items-center m-0">
                <li>
                  ...
                  <a href="my-account.html" class="text-uppercase item-anchor">Login</a>
                </li>
  ...
  <section id="videos">
    <div class="video-item position-relative">
      <div class="video-player">
        <img src="images/video-item.jpg" alt="video" class="video-image">
        ...
        <div class="swiper product-swiper">
          <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
              <div class="product-item position-relative">
                <div class="image-holder">
                  <img src="images/product-item6.jpg" alt="product-item" class="product-image">
                </div>
                <div class="cart-concern">
                  <div class="cart-button d-flex flex-wrap">
                    <div class="btn-left">
            ...
            <div class="swiper-slide">
              <div class="product-item position-relative">
                <div class="image-holder">
                  <img src="images/product-item7.jpg" alt="product-item" class="product-image">
                </div>
                <div class="cart-concern">
                  <div class="cart-button d-flex flex-wrap">
                    <div class="btn-left">
            ...
            <div class="swiper-slide">
              <div class="product-item position-relative">
                <div class="image-holder">
                  <img src="images/product-item8.jpg" alt="product-item" class="product-image">
                </div>
                <div class="cart-concern">
                  <div class="cart-button d-flex flex-wrap">
                    <div class="btn-left">
  ...
  <section id="categories" class="overflow-hidden">
    <div class="full-width-container d-flex flex-wrap">
      <div class="category-item left-block col-md-6 col-sm-12 no-padding-left position-relative">
        <div class="image-holder">
          <img src="images/category-item1.jpg" alt="fashion">
        </div>
      ...
      <div class="right-block col-md-6 col-sm-12 no-padding-right">
        <div class="category-item top-block position-relative">
          <div class="image-holder">
            <img src="images/category-item2.jpg" alt="fashion">
          </div>
          <div class="category-content content-light">
        ...
        <div class="category-item bottom-block position-relative">
          <div class="image-holder">
            <img src="images/category-item3.jpg" alt="fashion">
          </div>
          <div class="category-content content-light">
