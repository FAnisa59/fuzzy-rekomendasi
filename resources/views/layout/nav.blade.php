      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          <ul id="sidebarnav">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/perhitungan" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
                <span class="hide-menu">Perhitungan Fuzzy</span>
              </a>
            </li>
            <li class="sidebar-item">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/rekomendasi" aria-expanded="false">
                <span>
                  <i class="ti ti-article"></i>
                </span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/masuk" aria-expanded="false">
                ...
                <span class="hide-menu">Halaman Pemesanan</span>
              </a>
            </li>
            <li class="nav-small-cap">
              <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/login_admin" aria-expanded="false">
                <span>
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="/register_admin" aria-expanded="false">
                <span>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up" aria-labelledby="drop2">
                  <div class="message-body">
                    ...
                    <a href="/login_admin" class="btn btn-outline-primary mx-3 mt-2 d-block">Logout</a>
                  </div>
                </div>
              </li>
            </ul>
